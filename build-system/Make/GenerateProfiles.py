...
def encode_profile(profile, output):
    ...
    try:
        ...
        # Подписываем в DER/CMS формате, совместимом с openssl smime
        subprocess.run(
            [
                "security",
                "cms",
